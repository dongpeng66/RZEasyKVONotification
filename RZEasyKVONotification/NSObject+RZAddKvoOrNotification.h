//
//  NSObject+RZAddKvoOrNotification.h
...
@interface NSObject (RZAddKvoOrNotification)
#pragma mark - KVO
 ...
 *  @param userInfo 数据字典
 */
- (void)rz_postNotificationWithName:(NSString *)name userInfo:(nullable NSDictionary *)userInfo;
@end
